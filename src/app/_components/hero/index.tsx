...
">
        <section className="absolute top-20 p-8 z-[999] flex flex-col items-center text-center">
          ...
          <span className="hidden lg:inline text-3xl font-bold text-white mt-14 max-w-xl">
          ...
          <div className="hidden lg:flex flex-col items-center justify-center gap-6 mt-14">
            ...
            <button className="w-[230px] h-[50px] bg-blue-700 text-gray-200 font-extrabold rounded-xl text-2xl transition duration-200 hover:bg-blue-800 hover:text-white">
              <a
        ...
        <div className="absolute top-60 right-1/2 translate-x-1/2 lg:top-30 lg:right-[10%] lg:translate-x-0 p-8 mb-8 ">
          <Image
